...
#define FND_g_Pin GPIO_PIN_0
#define FND_g_GPIO_Port GPIOF
#define FND_f_Pin GPIO_PIN_1
...
#define PHOTO1_GPIO_Port GPIOG
#define PHOTO1_EXTI_IRQn EXTI0_IRQn
#define PHOTO2_Pin GPIO_PIN_1
#define PHOTO2_GPIO_Port GPIOG
#define PHOTO2_EXTI_IRQn EXTI1_IRQn
...
#define PHOTO3_GPIO_Port GPIOG
#define PHOTO3_EXTI_IRQn EXTI2_IRQn
#define PHOTO4_Pin GPIO_PIN_3
#define PHOTO4_GPIO_Port GPIOG
#define PHOTO4_EXTI_IRQn EXTI3_IRQn
#define USB_PowerSwitchOn_Pin GPIO_PIN_6
#define USB_PowerSwitchOn_GPIO_Port GPIOG
#define USB_OverCurrent_Pin GPIO_PIN_7
#define USB_OverCurrent_GPIO_Port GPIOG
#define FND_a_Pin GPIO_PIN_8
#define FND_a_GPIO_Port GPIOC
#define FND_b_Pin GPIO_PIN_9
#define FND_b_GPIO_Port GPIOC
...
#define FND_c_GPIO_Port GPIOC
#define FND_d_Pin GPIO_PIN_11
#define FND_d_GPIO_Port GPIOC
